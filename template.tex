...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Implementar o aplicativo de acesso do usuário utilizando React Native.
    \item Implementar a API que será responsável pelo reconhecimento de imagem e streaming do vídeo para o aplicativo, utilizando NodeJs.
  \end{itemize}
\end{itemize}
