...
Na aplicação a ser desenvolvida então, \emph{endpoints} serão desenvolvidos em NodeJS e disponibilizados ao usuário de forma que seja
possível realizar requisições HTTP para obter o acesso ao fluxo de vídeo, assim como outras funcionalidades.

\section{Algoritmo de reconhecimento facial}


\section{Tecnologias de segurança da informação}
