...
O React Native é um framework de desenvolvimento mobile híbrido (iOS e Android simultâneamente) criado 
pelo facebook, utilizando \emph{javascript} com a linguagem de programação e compilando-o de forma que
seja executável pela plataforma nativa. \cite{boduch2017react}. Assim sendo, Essa aplicação funcionará como a camada
\emph{View} do sistema.
