...
\titulo{Sistema de segurança doméstica: uma solução open source, customizável e auto-soberano} %TCC

\hypersetup{pdfkeywords={sistema distribuído}{auto-soberano}{distributed system}{}{palavra 5}} %TCC
...
No entanto, à medida que esses sistemas de vigilância aumentam em complexidade e tamanho, a necessidade de sistemas distribuídos, capazes de processar grandes quantidades de dados de maneira eficiente, torna-se cada vez mais aparente. Sistemas distribuídos podem lidar com a transmissão de informações em tempo real, o processamento paralelo de imagens e a redundância necessária para garantir a confiabilidade do sistema.

Além disso, a privacidade dos indivíduos é uma preocupação fundamental. Nesse contexto, tecnologias de código aberto podem oferecer uma solução, pois permitem que qualquer pessoa verifique se o proprietário está tratando a segurança e a privacidade de maneira adequada \cite{mardjan2016open}.
