...
dados de mídia. Através do ffmpeg \cite{ffmpeg}, é possível direcionar streams de vídeo para
o servidor MediaMTX, criando assim um ambiente propício para a integração e
operação eficiente do SSCS. 

Como é muito comum que sistemas de vigilância possuam várias câmeras ao mesmo tempo,
fazem sentido as duas arquiteturas nas figuras abaixo. Ambas as arquiteturas
são apenas a parte da transmissão para o servidor de mídia SSCS.
