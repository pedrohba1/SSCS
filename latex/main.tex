...
\texttt{godoc}, que é uma parte inerente do toolchain do Go. A \texttt{godoc}
examina os arquivos de código Go, extrai os comentários relevantes e
organiza-os em uma documentação legível, seja como HTML ou como texto puro.
Esta metodologia assegura que a documentação esteja fortemente acoplada com o
...
As convenções de comentários do Go são simples também. Para comentar um tipo,
variável, constante, função ou pacote, escreva o comentário diretamente antes
de sua declaração, sem linhas em branco. A \texttt{godoc} então será capaz de
apresentar o comentário junto com o item que está sendo documentado.
