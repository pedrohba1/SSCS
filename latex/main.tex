...
Todo o processo para a execução passo a passo está exemplificado no
\autoref{apendice}.    \chapter[Conclusão]{Conclusão}  Esse trabalho detalhou o
processo de desenvolvimento do SSCS. Inicialmente, foram levantados os
objetivos gerais e disso surgiram as funcionalidades (gravação, armazenamento,
reconhecimento) que resultaram, por sua vez, nos
componentes.%TCC:% ---% Conclusão% ---
