...
\begin{figure}[ht]
    ...
    \legend{Fonte: \href{https://docs.opencv.org/3.4/de/df4/tutorial_js_bg_subtraction.html}{Subtração de fundo no OpenCV} }
\end{figure}
...
\citeonline{Valera2005IntelligentDS} apresentam uma revisão generalizada do estado da arte
...
Em \citeonline{780272}, os autores demonstram um sistema de vigilância baseado em
vídeo para monitorar atividades em um estacionamento à ceu aberto,
...
Em \citeonline{Neal_2012} o uso de tecnologias de computação em nuvem são analisados
para a construção de um sistema de gerenciamento de vigilância. Após comparar e
investigar vários (\textit{\foreignlanguage{english}{Software as a Servcice}})
(SaaS), (\textit{\foreignlanguage{english}{Platform as a Service}}) (PaaS) e
(\textit{\foreignlanguage{english}{Infrastructure as a Service}}) (IaaS)
percebeu-se que é possível arquitetar um sistema do tipo, porém em larga escala
se torna mais caro e requer mais atenção às implicações legais e ameaças de
segurança.
...
interceptações e ataques. Como exemplo dessas falhas, em \citeonline{9116392} uma
