...
%TCC
	...
	\titulo{Sistema de vigilância \textit{\foreignlanguage{english}{open
source}} e
	customizável} %TCC

	\hypersetup{pdfkeywords={palavra 1}{palavra 2}{palavra 4}{palavra
4}{palavra
	5}} %TCC
...
continuamente durante 24 horas por dia. % Ends the current page and places the table at the top of the next page
