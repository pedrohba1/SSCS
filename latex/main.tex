...
De maneira resumida, essa primeiro computa-se a diferença do plano de fundo para o
primeiro plano usando o algoritmo citado anteriormente. Feito isso,
...
\section{Implementação do detector facial}
Essa implementação utiliza 
