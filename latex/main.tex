...
\begin{itemize}
	...
	\item Habilitar a busca de vídeos com critérios baseados nas
	      identificações realizadas pelos algoritmos de visão.
	...
	\item Adaptar o sistema para permitir variações nos métodos de
	      ...
	      arquivados.
	\item Escrever testes automatizados e
	      \textit{\foreignlanguage{english}{benchmarks}} para manter a qualidade do
	      software e das soluções em um nível aceitável.
...
Computing (NUC) ou um Single board computers (SBC).
...
\begin{figure}[!ht]
	...
	\caption[Diagrama da implementação do gerenciador de armazenamento
		...
		armazenamento usando o sistema operacional }
	\label{fig:graficosVariandoTamanhoRede}
\end{figure}
