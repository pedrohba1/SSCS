...
dados de mídia. Através do ffmpeg \cite{ffmpeg}, é possível direcionar streams
de vídeo para o servidor MediaMTX, criando assim um ambiente propício para a
integração e operação eficiente do SSCS.
...
arquiteturas lidam exclusivamente com a parte da transmissão para o servidor de mídia SSCS.
...
A arquitetura na figura 3, demonstra um caso onde as câmeras ou outras fontes de streaming podem enviar
streams para um único servidor intermediário. Esse servidor intermediário 
