...
monitorar o armazenamento em períodos de tempo definidos em segundos, apagando
ou movendo os arquivos mais antigos para que um limite do armazenamento
primário não seja excedido. Ao deletar ou mover para o armazenamento
secundário, ele também provê um evento, por meio de um canal, que descreve os
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.3\linewidth]{cleaner.pdf}
...
do diretório primário escolhido para armazenamento das gravações. Em seguida, eles são
ordenados por data de criação e os mais antigos podem ser movidos ou apagados,
dependendo de como o componente foi configurado.

\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.8\linewidth]{cleaneros.pdf}
...
A documentação é essencial para tornar o software acessível e simplificar sua
...
documentado. Veja como exemplo um comentário do pacote \texttt{recorgnizer} do
SSCS:
...
$  go doc  github.com/pedrohba1/SSCS/services/recorgnizer  	 
package recorgnizer // import "github.com/pedrohba1/SSCS/services/recorgnizer"

Package recorgnizer provides implementations for multiple image recognition algorithms.
