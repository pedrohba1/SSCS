...
recebidos por meio dos canais.					      Do ponto
de vista da arquitetura, o banco de dados é uma não-entidade. É um detalhe que
não se eleva ao nível de um elemento arquitetônico. Ele é uma utilidade que
provê acesso aos dados. No mesmo ponto de vista, essa utilidade é irrelevante
pois é um detalhe de baixo nível, ou seja, um mecanismo \cite{martin2018clean}.
...
\begin{figure}[htbp]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{../services/docs/rec1.jpeg}
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{../services/docs/rec2.jpeg}
